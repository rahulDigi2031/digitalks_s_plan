    ...
    <Box>
      ...
      <Box
        sx={{
          ...
          backgroundImage: "url(/aboutheroimg.png)",
      ...
      >
        <Container maxWidth="lg" sx={{ height: '100%', py: { xs: 4, sm: 6, md: 8 } }}>
          <Box sx={{ 
            display: 'flex', 
            alignItems: 'center', 
            height: '100%',
            ...
            <Box sx={{ 
              ...
              >
                ...
                >
                  Solving the everyday challenges of millions of businesses worldwide by
                  streamlining invoicing, accounting, compliance, business intelligence,
                  sales, payments, inventory, and more.
                </Typography>
              </motion.div>
            </Box>
          </Box>

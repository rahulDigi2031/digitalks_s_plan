...
export default function DeliveryChallanFormatSample(){
    ...
    return(
        <>
          ...
          <Container maxWidth="xl" sx={{ transition: 'opacity 300ms ease' }}>
            ...
            <Typography variant="h6" sx={{fontSize:{md:"30px" , xs:"auto" , textAlign:"center" , mb:5}}}>Delivery Challan Format (Fill and download it in PDF format.)</Typography>
            <br />

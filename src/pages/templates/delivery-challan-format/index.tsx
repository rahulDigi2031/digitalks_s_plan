...
import DeliveryChallanFormatSample from "./deliveryChallanFormatSample";
import WordDeliveryChallanformat from "./wordDeliveryChallanFormat";
import DeliveryChallanExcelFormat from "./excelDeliveryChallanFormat";
  ...
  return (
    <>
      <Box>
            ...
            <Container maxWidth="lg">
              ...
              >
                ...
                <Box sx={{ maxWidth: 640 }}>
                  ...
                  >
                   A delivery challan is used when goods are moved from one place to another without a sale. It records the transfer and confirms delivery, mainly for internal tracking.
                   Create and Download GST Delivery Challans & easily customise, print, and share with Refrens.
                  </Typography>
                  <Button
        ...
        <DeliveryChallanFormatSample />

        <WordDeliveryChallanformat />

        <DeliveryChallanExcelFormat />
           ...
           <Box sx={{bgcolor:"#7C3DDA" , width:"100%" , height:"100px" }}>
                <Container maxWidth="lg" sx={{display:"flex" , justifyContent:"space-evenly" , alignItems:"center" , height:"100px"}}>
                    <Typography variant="body1" sx={{fontSize:{md:"24px" , xs:""} , color:"white"}}>Generate Delivery Challans Free with Refrens Online Challan Generator</Typography>         
                    <Button variant="contained" sx={{bgcolor:"#E2007B" , color:"white"}}>Create Delivery Challan Now</Button>
                </Container>
            </Box>

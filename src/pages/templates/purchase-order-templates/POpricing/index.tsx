            ...
            <Box sx={{bgcolor:"#FBFCFD" , width:"100%" , py: 8}}>
                <Container maxWidth="lg">
                    <Typography variant="h3" sx={{ fontWeight: 700, mb: 2, textAlign: 'center' }}>
                        Pricing of Purchase Order Format
                    </Typography>
                    ...
                    <Box sx={{ display: 'flex', gap: 4, justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <Box sx={{ 
                            ...
                            <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3, lineHeight: 1.6 }}>
                                All of our premium features are available on free trial. Experience what all Refrens has to offer without making any payment.
                            </Typography>

...
export default function TaxInvoiceFormat(){
    ...
    return(
        <>
          ...
          <Container maxWidth="xl" sx={{ transition: 'opacity 300ms ease' }}>


            <Typography variant="h6" sx={{fontSize:{md:"30px" , xs:"auto" , textAlign:"center" , mb:5}}}>Tax Invoice Template in PDF (Add invoice details and download it in PDF format.)</Typography>
              ...
              <Box sx={{ 
                ...
                <Paper elevation={2} sx={{ p: 3, backgroundColor: 'white' }}>
                  ...
                  <Box sx={{ 
                    ...
                    <Box sx={{ flex: { xs: 1, md: 1/3 } }}>
                      <Button fullWidth variant="contained" color="primary" size="small" sx={{ borderRadius: 1, backgroundColor: '#E2007B', textTransform: 'none', '&:hover': { backgroundColor: '#7B61FF' } }}>
                        Save & Continue
                      </Button>
                    </Box>
                  </Box>

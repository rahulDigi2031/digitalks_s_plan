...
import TaxInvoiceFormat from "./taxInvoiceFormat";
import TaxInvoiceWordTemplates from "./taxInvoiceWordTemplates";
import TaxInvoiceExcelTemplates from "./taxInvoiceExcelTemplates";
import TaxInvoiceIntroduction from "./taxInvoiceIntro";
import TaxInvoiceAdvance from "./taxInvoiceAdvance";
import TaxInvoiceCreateInExcel from "./taxINVCreateExcel";
import AddtionalToolsTaxInvoice from "./additionalToolsTaxInvoice";
      ...
      <Box>
        ...
        <main>
            ...
            <Container maxWidth="lg">
              <Box
                ...
                <Box sx={{ maxWidth: 640 }}>
                  ...
                  >
                    Downloadable Tax Invoice Template for FREE
                    Customize and Download as PDF. Unlimited Invoices
                  </Typography>
                  <Button
          ...
          <Box sx={{display:'flex' , justifyContent:"center" , alignItems:"center" , bgcolor:"#E9E0F8" , width:"100%" , height:"70px"}}>
                <Typography variant="body1">Our Users Rate Refrens ⭐ 4.8/5 based on 11700+ Ratings</Typography> 
          </Box>

          {/* invoice format below-side */}
           
          <TaxInvoiceFormat /> 

          <TaxInvoiceWordTemplates />

          <TaxInvoiceExcelTemplates />
          
          <Box sx={{bgcolor:"#7C3DDA" , width:"100%" , height:"100px" }}>
               <Container maxWidth="lg" sx={{display:"flex" , justifyContent:"space-evenly" , alignItems:"center" , height:"100px"}}>
                <Typography variant="body1" sx={{fontSize:{md:"26px" , xs:""} , color:"white"}}>Get Your Free Tax Invoice Template Now</Typography>

               <Button variant="contained" sx={{bgcolor:"#E2007B" , color:"white"}}>Create Free Invoice</Button>
               </Container>
          </Box>

          <TaxInvoiceIntroduction />

          <TaxInvoiceAdvance />

          <TaxInvoiceCreateInExcel />

          <AddtionalToolsTaxInvoice />
